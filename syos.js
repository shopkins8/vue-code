Vue.component('syos', {
                         ...
                         <thead class="sr-only">
                          ...
                          <tbody>
                              <tr v-for="price in seatPriceArray" :data-circle="this.circleID" :data-zone-name="this.zone" :data-section-name="this.section" :data-row="this.row" :data-seat="this.seatNumber" :data-type="this.seatType" :data-price="this.formattedPrice">
                                  ...
                                  <td>
                                      <button :data-seat-no="this.seatNumber" :data-price-type="price.formattedPrice" data-label="add-to-cart" class="add-to-cart float-right" @click="pushToCart(false, price.priceType, price.formattedPrice, price.ticketType)">Select</button>
                                  </td>
                              </tr>
                          </tbody>
                      </table>
                ...
                <div class="container-fluid">
                    <div class="row bg-dark">
                        <div class="col mf-col">
                            <i class="fas fa-arrow-up rotate collapsed" @click="this.rotateArrow" data-toggle="collapse" data-label="Expand Cart" href="#tableCheckoutRow" role="button" aria-expanded="false" aria-controls="tableCheckoutRow"></i>
                            <p v-if="cartTotal > 0" class="mf-description">
                                <span id="seat-count">{{cartTotal}}</span> <span id="seat-text">{{this.seatPlural}} Added</span>
                            </p>
                            <p v-else class="mf-description">
    ...
    data() {
        return {
            ...
            customIcons: {
                wheelchair: '<g style="pointer-events:none;"><svg height="6" width="6" class="svg-inline--fa fa-wheelchair fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="pointer-events: none;"><path fill="currentColor" d="M496.101 385.669l14.227 28.663c3.929 7.915.697 17.516-7.218 21.445l-65.465 32.886c-16.049 7.967-35.556 1.194-43.189-15.055L331.679 320H192c-15.925 0-29.426-11.71-31.679-27.475C126.433 55.308 128.38 70.044 128 64c0-36.358 30.318-65.635 67.052-63.929 33.271 1.545 60.048 28.905 60.925 62.201.868 32.933-23.152 60.423-54.608 65.039l4.67 32.69H336c8.837 0 16 7.163 16 16v32c0 8.837-7.163 16-16 16H215.182l4.572 32H352a32 32 0 0 1 28.962 18.392L438.477 396.8l36.178-18.349c7.915-3.929 17.517-.697 21.446 7.218zM311.358 352h-24.506c-7.788 54.204-54.528 96-110.852 96-61.757 0-112-50.243-112-112 0-41.505 22.694-77.809 56.324-97.156-3.712-25.965-6.844-47.86-9.488-66.333C45.956 198.464 0 261.963 0 336c0 97.047 78.953 176 176 176 71.87 0 133.806-43.308 161.11-105.192L311.358 352z"></path></svg></g>',
                universalAccess: '<g style="pointer-events:none;"><svg height="6" width="6" class="svg-inline--fa fa-universal-access fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="pointer-events: none;"><path fill="currentColor" d="M256 48c114.953 0 208 93.029 208 208 0 114.953-93.029 208-208 208-114.953 0-208-93.029-208-208 0-114.953 93.029-208 208-208m0-40C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 56C149.961 64 64 149.961 64 256s85.961 192 192 192 192-85.961 192-192S362.039 64 256 64zm0 44c19.882 0 36 16.118 36 36s-16.118 36-36 36-36-16.118-36-36 16.118-36 36-36zm117.741 98.023c-28.712 6.779-55.511 12.748-82.14 15.807.851 101.023 12.306 123.052 25.037 155.621 3.617 9.26-.957 19.698-10.217 23.315-9.261 3.617-19.699-.957-23.316-10.217-8.705-22.308-17.086-40.636-22.261-78.549h-9.686c-5.167 37.851-13.534 56.208-22.262 78.549-3.615 9.255-14.05 13.836-23
role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" style="pointer-events: none;"><path fill="currentColor" d="M380.15 510.837a8 8 0 0 1-10.989-2.687l-125.33-206.427a31.923 31.923 0 0 0 12.958-9.485l126.048 207.608a8 8 0 0 1-2.687 10.991zM142.803 314.338l-32.54 89.485 36.12 88.285c6.693 16.36 25.377 24.192 41.733 17.501 16.357-6.692 24.193-25.376 17.501-41.734l-62.814-153.537zM96 88c24.301 0 44-19.699 44-44S120.301 0 96 0 52 19.699 52 44s19.699 44 44 44zm154.837 169.128l-120-152c-4.733-5.995-11.75-9.108-18.837-9.112V96H80v.026c-7.146.003-14.217 3.161-18.944 9.24L0 183.766v95.694c0 13.455 11.011 24.791 24.464 24.536C37.505 303.748 48 293.1 48 280v-79.766l16-20.571v140.698L9.927 469.055c-6.04 16.609 2.528 34.969 19.138 41.009 16.602 6.039 34.968-2.524 41.009-19.138L136 309.638V202.441l-31.406-39.816a4 4 0 1 1 6.269-4.971l102.3 129.217c9.145 11.584 24.368 11.339 33.708 3.965 10.41-8.216 12.159-23.334 3.966-33.708z"></path></svg></g>',
                audioDescription: '<g style="pointer-events:none;"><svg height="6" width="6" class="svg-inline--fa fa-audio-description fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="pointer-events: none;"><path fill="currentColor" d="M162.925 238.709l8.822 30.655h-25.606l9.041-30.652c1.277-4.421 2.651-9.994 3.872-15.245 1.22 5.251 2.594 10.823 3.871 15.242zm166.474-32.099h-14.523v98.781h14.523c29.776 0 46.175-17.678 46.175-49.776 0-32.239-17.49-49.005-46.175-49.005zM512 112v288c0 26.51-21.49 48-48 48H48c-26.51 0-48-21.49-48-48V112c0-26.51 21.49-48 48-48h416c26.51 0 48 21.49 48 48zM245.459 336.139l-57.097-168A12.001 12.001 0 0 0 177 160h-35.894a12.001 12.001 0 0 0-11.362 8.139l-57.097 168C70.003 343.922 75.789 352 84.009 352h29.133a12 12 0 0 0 11.535-8.693l8.574-29.906h51.367l8.793 29.977A12 12 0 0 0 204.926 352h29.172c8.22 0 14.006-8.078 11.361-15.861zm184.701-80.525c0-58.977-37.919-95.614-98.96-95.614h-57.366c-6.627 0-12 5.373-12 12v168c0 6.627 5.373 12 12 12H331.2c61.041 0 98.96-36.933 98.96-96.386z"></path></svg></g>',
                dotCircle: '<g style="pointer-events:none;"><svg height="6" width="6" class="svg-inline--fa fa-dot-circle fa-w-16" role="img" viewBox="0 0 512 512"><path fill="currentColor" d="M256 56c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m0-48C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 168c-44.183 0-80 35.817-80 80s35.817 80 80 80 80-35.817 80-80-35.817-80-80-80z"/></svg></g>',
                square: '<g style="pointer-events:none;"><svg height="6" width="6" class="svg-inline--fa fa-square fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48z"></path></svg></g>',
                star: '<g style="pointer-events:none;"><svg  height="6" width="6"  class="svg-inline--fa fa-star fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"></path></svg></g>',
                lines: '<g style="pointer-events:none;"><svg height="6" width="6" class="svg-inline--fa fa-grip-lines fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M496 288H16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h480c8.8 0 16-7.2 16-16v-32c0-8.8-7.2-16-16-16zm0-128H16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h480c8.8 0 16-7.2 16-16v-32c0-8.8-7.2-16-16-16z"></path></svg></g>',
            },
            priceLevels: null,
            activePriceLevel: 0,
            overviewMap: null,
    ...
    watch: {
        perfnum: function () {
            ...
            this.resetOverview();
            this.loading = true;
            this.loadSyosConfig(true).then( () => this.loadSyos(true) ).then( () => this.sortData(true) ).then( () => this.applyHandlers() ).then( () => this.applyColor() ).then( () => this.loading = false ).then( () => this.setSyosViewportHeight(false, true) );
        },
    ...
    mounted() {
        this.loadSyosConfig().then( () => this.loadSyos() ).then( () => this.sortData() ).then( () => this.applyHandlers() ).then( () => this.applyColor() ).then( () => this.loading = false ).then( () => this.setSyosViewportHeight(false, true) );
        window.addEventListener('resize', this.setSyosViewportHeight);
        window.addEventListener('touchstart', this.setSyosViewportHeight);
        document.body.classList.add('lock-scroll');
    },

    methods: {
        sortData(reload) {
            if (this.dataResult.result) {
                this.title = this.dataResult.data.title;
                this.venueDescription = this.dataResult.data.venue_description;
                this.dates = this.dataResult.data.performances;
                if (this.dataResult.data.promo_code) {
                    if (this.dataResult.data.promo_code.PromoCode) {
                        this.promoCode = this.dataResult.data.promo_code.PromoCode;
                        this.appliedPromoCode = this.dataResult.data.promo_code.PromoCode;
                    } else {
                        this.promoCode = this.dataResult.data.promo_code.Source.Description;
                        this.appliedPromoCode = this.dataResult.data.promo_code.Source.Description;
                    }

                }
                this.packageid = this.dataResult.data.package_id;
                this.svgs = this.dataResult.data.floors;
                this.initialFloor = this.dataResult.data.floors[0].svg;
                if (this.initialFloor === null) {
                    this.error = 'There was an error loading the floors. Please refresh your browser.';
                    // set global active floor to 0??
                }

                // RUN CHECK ON CURRENT VIEWERS
                if (this.dataResult.data.current_viewer_count >= this.dataResult.data.current_viewer_display_threshold && this.showViewerCount === true) {
                    this.viewerCount = this.dataResult.data.current_viewer_count;
                }


                if (this.dataResult.data.facility_id) {
                    ///// check facility here
                    this.facilityID = parseInt(this.dataResult.data.facility_id);
                    if (this.configResult.facilities) {
                        for (const [id, facility] of Object.entries(this.configResult.facilities)) {
                            if (parseInt(id) === parseInt(this.facilityID)) {
                                this.syosFacility = facility;
                                /// clean up svg code here
                                if (facility.overviewSVG) {
                                    this.overviewSVG = facility.overviewSVG.replace(/\\/g, '');
                                }
                                if(facility.overviewMap) {
                                    this.overviewMap = this.syosFacility.overviewMap;
                                    this.overviewMapHold = this.syosFacility.overviewMap;
                                    this.overviewMapHeight = this.syosFacility.overviewMapHeight;
                                    this.overviewMapWidth = this.syosFacility.overviewMapWidth;
                                }
                                this.overviewLabel = facility.overviewLabel;
                                this.seatLabel = facility.seatLabel;
                                if (facility.price_hover) {
                                    this.priceHover = true;
                                }
                                if (facility.constant_color) {
                                    this.constantColor = true;
                                }
                                break;
                            } else {
                                this.syosFacility = this.dataResult.data.facility_id;
                            }
                        }
                    }
                }

                if (this.dataResult.data.seat_map) {
                    this.seatMapName = this.dataResult.data.seat_map;
                }
                ...
                if (this.dataResult.data.price_type_data) {
                    // pass types into container
                    this.dataResult.data.price_type_data.forEach((code) => {
                        if (code.only_holdcodes) {
                            const holdCodeArray = code.only_holdcodes.split(',');
                            holdCodeArray.forEach((holdCode) => {
                                this.onlyHoldCodes.push(holdCode);
                            });
                ...
                // button labels
                if (parseInt(this.dataResult.data.package_id) === 0) {

                    if (this.exchange === '') {
                        this.exchangeLabel = 'Checkout';
                    } else {
                        if (this.configResult.data.labels.exchange) {
                            this.exchangeLabel = this.configResult.data.labels.exchange;
                        }
                    }

                } else {
                    if (this.perfnum === 'fixed') {
                        this.exchangeLabel = 'Checkout';
                    } else {
                        this.exchangeLabel = 'Add to Package';
                    }
                }
            } else {
                this.error = this.dataResult.data.error;
            }
            return this;
        },
        ...
        applyHandlers() {
            ...
            floors.forEach((floor) => {
                ...
                this.svgs.forEach((svg) => {
                    if(parseInt(floorCompareId) === parseInt(svg.id)) {
                        ...
                        tmpFloorClassName = svg.floor_name;
                        tmpFloorClassName = tmpFloorClassName.replace(/ /g, '');
                        tmpFloorClassName = tmpFloorClassName.replace(/&/g, '');
                        tmpFloorClassName = tmpFloorClassName.replace(/,/g, '');
                        ...
                        if(this.syosFacility.overviewMap) {
                            for (const [name, info] of Object.entries(this.syosFacility.overview)) {
            ...
            seats.forEach(seat => {
                ...
                seat.addEventListener('touchstart',(el) => {
                    const tmpseatID = seat.id;
                    this.updateClick(tmpseatID);
                    el.preventDefault();
                });
            ...
            this.initiateZoom();
            if(this.syosFacility) {
                if(this.syosFacility.price_levels) {
                    this.priceLevels = this.syosFacility.price_levels;
                    this.applyPriceLevels();
                }
                if(this.syosFacility.photo_preview) {
                    this.applyPreviews(this.syosFacility.photo_preview);
                }
                if(this.syosFacility.overview) {
                    if(this.overviewSVG) {
                        this.allFloorsInfo.forEach((floor) => {
                            if(floor.available_count === 0) {
                                ...
                                tmpID = tmpID.replace(/&/g, '');
                                tmpID = tmpID.replace(/,/g, '');
                                for (const [id, name] of Object.entries(this.syosFacility.overview)) {
                                    if(tmpID === id) {
                                        let oldFloor = document.getElementById(name.svgID);
                                        oldFloor.classList.add('disabled');
                                        let newFloor = oldFloor.cloneNode(true);
                                        oldFloor.parentNode.replaceChild(newFloor, oldFloor);
                                    }
                                }
                            }
                            else if(floor.available_count > 0) {
                                let tmpID = floor.floor_name;
                                tmpID = tmpID.replace(/ /g, '');
                                tmpID = tmpID.replace(/&/g, '');
                                tmpID = tmpID.replace(/,/g, '');
                                for (const [id, name] of Object.entries(this.syosFacility.overview)) {
                                    if(tmpID === id) {
                                        document.getElementById(name.svgID).classList.remove('disabled');
                                    }
                                }
                            }
                        });
                    ...
                    else if(this.syosFacility.overviewMap) {
                        for (const [id, name] of Object.entries(this.syosFacility.overview)) {
                            this.allFloorsInfo.forEach((floor) => {
                                if(floor.available_count === 0) {
                                    let tmpID = floor.floor_name;
        ...
        applyColor() {
            var css = '#syos .seat{ fill: ' + this.configResult.legend.unavailable.seat_code_color + '; }';
            css += '#syos .seat.available{ fill: ' + this.configResult.legend.available.seat_code_color + '; }';
            css += '#syos .modal-footer a#checkout{ background-color: ' + this.configResult.colors.add_to_cart + '!important; }';
            css += '#syos .floor-selection li:hover{ background-color: ' + this.configResult.colors.nav_hover_color + '; }';
            css += '#syos .overview-svg [id^=syos-floor-] > *:first-child{ fill: ' + this.configResult.colors.overview_standard_color + '; }';
            css += '#syos .overview-svg [id^=syos-floor-]:hover > *:first-child{ fill: ' + this.configResult.colors.overview_hover_color + '; }';
            css += '#syos .overview-svg [id^=syos-floor-].disabled > *:first-child{ fill: grey; }#syos .overview-svg [id^=syos-floor-].disabled:hover > *:first-child{fill: grey;}';
            css += '#syos .seat.available.clicked{ fill: ' + this.configResult.colors.seat_clicked + '!important; }';
            css += '#syos .seat.available:hover{ fill: ' + this.configResult.colors.seat_hover + '!important; }';
            css += '#syos .seat-data h6{ background-color: ' + this.configResult.colors.seat_message + '!important; }';
            css += '#syos .seat-data h6:first-of-type{ background-color: ' + this.configResult.colors.seat_hover + '!important; }';
            css += '#syos .seat.available.user-selected-seat{ fill: ' + this.configResult.colors.seat_reserved + '!important; }';
            css += '.floorsvg .seat[data-seat-status="6"]{ display: none !important;} ';
            css += '#syos .seat-selection-details button{ background-color: ' + this.configResult.colors.select_button +'} ';
            css += '#syos .mobile-floor-button [id^=syos-floor-] > *:first-child{ fill: ' + this.configResult.colors.overview_standard_color + '; }';
            ...
            if(this.syosFacility) {
                for (const [id, name] of Object.entries(this.syosFacility.overview)) {
                    ...
                    cleanName = cleanName.replace(/&/g, '');
                    cleanName = cleanName.replace(/,/g, '');
                    css += '#syos .mobile-floor-button.'+ cleanName + ' #'+ name.svgID +' > *:first-child{ fill: ' + this.configResult.colors.overview_hover_color + '; }';

                }
            }
            css += '#syos .mobile-floor-button [id^=syos-floor-].disabled > *:first-child{ fill: grey; }#syos .overview-svg [id^=syos-floor-].disabled:hover > *:first-child{fill: grey;}';

            this.legends.forEach((item) => {
                if (item.ids) {
                    if (item.display_standard) {
                        // do nothing, it should look normal
                    } else {
                        item.ids.forEach((id) => {
                            const query = '[' + item.dataType + '="' + id + '"]';
                            css += '#syos .seat' + query + '{fill:' + item.seat_code_color + '};';
                        });
                    }
                }
            });
        ...
        closeMessageWindow() {
            ...
            this.holdMessage = '';
            document.getElementById(this.holdItem.circle).classList.remove('user-selected-seat');
            this.holdItem = null;
        },
        ...
        closeMessageAddCart() {
            ...
            this.holdItem = null;
            // continue process of adding seat to cart
            // release active seat class on seat
        ...
        async applyPromo() {
            // disable button
            this.promoMessage = null;
            const tmpButton = document.getElementById('promocode-submit');
            tmpButton.setAttribute('disabled', 'disabled');
            tmpButton.innerHTML = 'Loading...';

            try {
                const promoURL = '/ajax/promocode/' + this.promoCode;
                const response = await fetch(promoURL, {
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json',
                        'X-Requested-With': 'XMLHttpRequest',
                        'X-submitSourceNumber': this.submitSourceNumber,
                    },
                });
                this.promoResponse = await response.json();
            } catch (err) {
                this.error = err;
            } finally {
                if (!this.promoResponse) {
                    this.promoMessage = this.configResult.promo_codes.errorText;
                    this.promoResponse = null;
                    this.promoCode = null;
                    tmpButton.removeAttribute('disabled');
                    tmpButton.innerHTML = 'Apply';
                } else {
                    let url = window.location.href;
                    if (url.indexOf('?') > -1) {
                        let newURL = url.split('?')[0];
                        newURL += '?syos=true&perf=' + this.perfnum;
                        window.location.href = newURL;
                    } else {
                        url += '?syos=true&perf=' + this.perfnum;
        ...
        async removePromo() {
            const removePromoButton = document.getElementById('remove-promo');
            removePromoButton.setAttribute('disabled', 'disabled');
            try {
                const promoURL = '/ajax/promocode/' + this.appliedPromoCode + '/remove';
                const response = await fetch(promoURL, {
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json',
                ...
                if (!this.promoResponse) {
                    ...
                    removePromoButton.removeAttribute('disabled');
                    this.promoCode = null;
                    let url = window.location.href;
                    if (url.indexOf('?') > -1) {
                        let newURL = url.split('?')[0];
        ...
        outerHeight(calcElement, withMargin) {
            let height = calcElement.offsetHeight;
            if (withMargin) {
                let style = getComputedStyle(calcElement);
        ...
        getPaddingMargin(el) {
            ...
            paddingMargin = parseInt(style.paddingTop) + parseInt(style.paddingBottom) + parseInt(style.marginTop) + parseInt(style.marginBottom);
            return paddingMargin;
        },

        setSyosViewportHeight(event) {
            if(event) {
                if(event.type === "resize") {
                    let windowHeight = window.innerHeight;
                    // Header of modal height
                    let modalheader = document.querySelectorAll('#syos .modal-header');
                    modalheader = modalheader[0];
                    modalheader = this.outerHeight(modalheader, true);
                    // select body to set height there
                    let modalBody = document.querySelectorAll('#syos .modal-body');
                    modalBody = modalBody[0];
                    // footer of modal height
                    let modalFooter = document.querySelectorAll('#syos .modal-footer');
                    modalFooter = modalFooter[0];
                    modalFooter = this.outerHeight(modalFooter, true);
                    // the height of the margin and padding of the modal, THIS IS JUST THE MARGIN AND PADDING

                    let modalDialog = document.querySelectorAll('#syos .modal-dialog');
                    modalDialog = modalDialog[0];
                    let modalPaddingMargin = this.getPaddingMargin(modalDialog);
                    let viewPortHeight = windowHeight - modalheader - modalPaddingMargin;

                    viewPortHeight = viewPortHeight + 'px';
                    modalBody.style.height = viewPortHeight;
                }
                if (event.touches.length === 2) {
                    // do nothing because we want the default zooms
        ...
        reloadSyos(value) {
            this.perfnum = value;
            this.loading = true;
            this.loadSyosConfig(true).then( () => this.loadSyos(true) ).then( () => this.sortData(true) ).then( () => this.applyHandlers(true) ).then( () => this.applyColor() ).then( () => this.loading = false ).then( () => this.setSyosViewportHeight(false, true) );
        },

        applySeatMaps() {
            if (this.seatMaps) {
                for (const [id, map] of Object.entries(this.seatMaps)) {
                    if (id === this.seatMapName) {
                        map.seat_codes.forEach((legend) => {
                            if (legend.add_to_legend) {
                                let legendItem = {
                                    seat_code_color: legend.color,
                                    seat_code_title: legend.label,
                                    ids: legend.ids,
                                    dataType: 'data-seat-type-id',
                                }
                                this.applyLegend(legendItem);
                            }
                        });
                        this.seatMapInfo = map.seat_codes;
                    }
                }
            }
        },

        async loadSyosConfig(reload) {
            try {
                const response = await fetch('/ajax/syos/config', {
                    method: 'GET',
                    headers: {
                ...
                if (reload) {
                    ...
                    if (this.configResult.legend) {
                        for (const [id, legend] of Object.entries(this.configResult.legend)) {
                            this.legends.push(legend);
                        }
                    }

                    if (this.configResult.seat_maps) {
                        this.seatMaps = this.configResult.seat_maps;
                    }

                    if (this.configResult.zoom_levels) {
                        /* pull in zoom levels to override defaults, then convert them to int with appropriate decimals */
                        let steppedMin = parseInt(this.configResult.zoom_levels.min);
                        steppedMin = steppedMin * .1;
                        this.zoomMin = steppedMin;
                        let steppedInc = parseInt(this.configResult.zoom_levels.zoom_increment);
                        steppedInc = steppedInc * .1;
                        this.zoomIncrement = steppedInc;
                        this.zoomMax = parseInt(this.configResult.zoom_levels.max);
                    }

                    if (this.configResult.hold_codes) {
                        this.holdCodes = this.configResult.hold_codes;
                        this.holdCodes.forEach((holdCode) => {
                            if (holdCode.display_standard) {

                            } else {
                                if (holdCode.add_to_legend) {
                                    if (holdCode.custom_icon) {
                                    }
                                    if (holdCode.custom_icon == '0') {

                                    }
                                    let holdCodeItem = {
                                        seat_code_color: holdCode.color,
                                        seat_code_title: holdCode.label,
                                        ids: holdCode.ids,
                                        dataType: "data-hold-code-id",
                                        custom_icon: holdCode.custom_icon,
                                    }
                                    this.applyLegend(holdCodeItem);
                                }
                            }
                    ...
                    if (this.configResult.promo_codes) {
                        this.promoText = this.configResult.promo_codes.enterText;
                        if (this.configResult.promo_codes.submit_source_number) {
                            this.submitSourceNumber = 'true';
                        }
                    }

                    if (this.configResult.seat_data) {
                        this.seatDataArray = this.configResult.seat_data.accessible;
                    }

                    if (this.configResult.zone_colors) {
                        this.zoneColors = this.configResult.zone_colors;
                    }

                    if (this.configResult.redirect) {
                        this.redirectlocation = this.configResult.redirect;
                    }

                    if(this.configResult.backButtonLabel) {
                        this.backButtonLabel = this.configResult.backButtonLabel;
                    }
                    if(this.configResult.seatPriceReverse) {
                        this.seatPriceSortReverse = true;
                    }
                    if(this.configResult.hideThreshold) {
                        this.hideThreshold = true;
                    }
                }
        ...
        async loadSyos(reload) {
            const fetchURL = '/ajax/syos/get-data/' + this.perfnum + '/' + this.packagepostid + '/' + ((this.lineitemid == null || this.lineitemid == '') ? 'false' : this.lineitemid) + '/' + (this.exchange === '' ? 'false' : this.exchange);
            try {
                ...
                this.dataResult = await response.json();
            } catch (err) {
                this.error = err;
            } finally {
            }
        ...
        async cartCheckout() {
            ...
            let priceTypes = [];
            let perfNos = [];
            for (const [id, item] of Object.entries(this.cartArray)) {
                seatNumbers.push(item.seatNumber);
                //holdCodes.push(item.holdCodes);
                priceTypes.push(item.priceType);
                perfNos.push(item.tessiPerfNo);
            }
            this.loadingMessage = 'Adding Tickets...';
            let tmptest = new URLSearchParams();
            tmptest.append('perf_no', this.dataResult.data.perf_no);
            tmptest.append('seat_no', seatNumbers);

            tmptest.append('package_id', this.packageid);
            tmptest.append('price_type', priceTypes);
            tmptest.append('hold_code', holdCodes);
            tmptest.append('line_item_id', this.lineitemid);
            tmptest.append('exchange', this.exchange);
            try {
                const checkoutResponse = await fetch('/ajax/syos/reserve', {
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json',
                        'X-Requested-With': 'XMLHttpRequest',
                ...
                this.cartResult = await checkoutResponse.json();
            } catch (err) {
                this.error = err;
            } finally {

                if (this.aftersuccess === 'reload') {
                    this.exchangeLabel = 'Reloading...';
                    window.location.reload(true);
                } else {
                    this.exchangeLabel = 'Redirecting...';
        ...
        rotateArrow() {
            let arrow = document.querySelectorAll('#syos .fa-arrow-up');
            arrow = arrow[0];
            arrow.click();
            let expanded = arrow.getAttribute('aria-expanded');
            if (expanded == "true") {
                expanded = "false";
        ...
        removeFromCart(circle, idx) {
            document.getElementById(circle).classList.remove('user-selected-seat');
        ...
        getPosition(seat, box) {
            ...
            const calculatedTop = seat.getBoundingClientRect().top - svgPosition.getBoundingClientRect().top - outerHeight;
            let headerHeight = document.querySelectorAll('#syos .modal-header')[0].offsetHeight;
            if(calculatedTop < (headerHeight * -1)) {
                this.descriptionTop = seat.getBoundingClientRect().top - svgPosition.getBoundingClientRect().top;
                this.descriptionLeft = seat.getBoundingClientRect().left;
            }
            else {
                this.descriptionTop = calculatedTop;
        ...
        updateHover(id) {
            ...
            if (clicked.length > 0) {
                ...
                tmpseatPriceArray.forEach((priceObject) => {
                    ...
                    let rawPrice = tmpSplit[1];

                    tmpSplit[1] = formatter.format(tmpSplit[1]);

                    let ticketObject = {
                        priceType: tmpSplit[0],
                        formattedPrice: tmpSplit[1],
                        ticketType: tmpSplit[2],
                        Boolean: tmpSplit[3],
                        rawPrice: rawPrice,
                    };

                    this.seatPriceArray.push(ticketObject);
        ...
        updateClick(id) {
            ...
            if(this.seatPriceSortReverse === true) {
                this.seatPriceArray.sort((a, b) => {
        ...
        applyIcon(seat, icon) {
            let seatTransform = seat.getAttribute('transform');
            ...
            seat.nextSibling.firstChild.setAttribute('x', xCoord);
            seat.nextSibling.firstChild.setAttribute('y', yCoord);
            if(seatTransform) {
                seat.nextSibling.setAttribute('transform', seatTransform);
            }
        },
        ...
        applyLegendIcon(dot, icon) {
            const svg = this.customIcons[icon];
            dot.innerHTML = svg;
            dot.firstElementChild.firstChild.style.cssText = "height: 14px;width:14px;";
        },
            ...
            for (const [id, level] of Object.entries(this.priceLevels)) {
                ...
                if (level.color === "#000000") {
                    ...
                    if (this.constantColor) {
                        priceLevelStyles = priceLevelStyles + '.floorsvg .available[data-price-level="' + id + '"]{fill:rgba(' + rgbColor + ',1) !important; transition: fill .2s ease;}';
                    } else {
        ...
        pushToCart(bypass, type, price, typeName) {
            ...
            if (seat.classList.contains('user-selected-seat')) {
                ...
                this.cartItem = {
                    ...
                    tessiPerfNo: this.dataResult.data.perf_no,
                }
                this.showMessage(holdMessage, this.cartItem);
